...
if(isset($_POST['clearfilters'])) {
	unset($_SESSION['filtercondc']);
	unset($_SESSION['filterarrayc']);
	...
	<tbody>
		<form class="form-inline" method = "POST">
			<tr>
				...
				<select class="form-control" style = "height: 5%;" disabled>
					<?php echo "<option value = '".$_SESSION['name']."'> ".$_SESSION['name']." </option>"; ?>
				</select>
				<?php echo "<input type = 'hidden' name = 'comm' id = 'comm' value = '".$_SESSION['name']."'"; ?>
				</div></td>
...
if(isset($_POST['filsub'])) {
	...
	$_SESSION['filtercondc'] = $q;
	$_SESSION['filterarrayc'] = $_POST;
	header('location: comm.php');
