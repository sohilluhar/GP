						...
						<?php
							if(isset($_POST['toggle'])) {
								if($_POST['toggle'] == 'pending') {
									...
									$qu = "SELECT * FROM grievance where (gcat='Scholarship') AND (status = 'Pending')";
									...
									$qu = "SELECT * FROM grievance where (gcat='Scholarship') AND (status = 'In Progress')";
									...
									$qu = "SELECT * FROM grievance where (gcat='Scholarship') AND (status='Raised to Principal')";
									...
									$qu = "SELECT * FROM resolved where (gcat='Scholarship') AND (status='Action Taken')";
