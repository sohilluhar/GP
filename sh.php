						...
						<?php
							if(isset($_POST['toggle'])) {
								if($_POST['toggle'] == 'pending') {
									...
									$qu = "SELECT * FROM grievance where (gcat='Harassment') AND (status = 'Pending')";
									...
									echo "<th>Grievance id</th>
										...
										<th>Send acknowledgement to student</th>
										<th>Raise issue to Principal</th>";
								}
								
								else if($_POST['toggle'] == 'in_progress') {
									
									$qu = "SELECT * FROM grievance where (gcat='Harassment') AND (status = 'In Progress')";
									...
									$qu = "SELECT * FROM grievance where (gcat='Harassment') AND (status='Raised to Principal')";
									...
									$qu = "SELECT * FROM resolved where (gcat='Harassment') AND (status='Action Taken')";
